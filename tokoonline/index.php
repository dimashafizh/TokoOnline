...
<body>
    ...
    <div class="container-fluid warna3 py-5">
        <div class="container text-center">
            <h3>Tentang Kami</h3>
            <p class="fs-5 mt-3">
            Selamat datang Toko Online kami, destinasi utama untuk gaya yang menginspirasi. Kami menawarkan koleksi pakaian terkini yang dipilih dengan cermat, mencakup beragam gaya dan ukuran untuk memenuhi kebutuhan fashion setiap individu. Dengan fokus pada kualitas dan keunikan desain, kami berkomitmen memberikan pengalaman belanja online yang aman, nyaman, dan memuaskan. Ayo temukan gaya Anda!
            </p>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container text-center">
            ...
            <a class="btn warna1 mt-3 text-white" href="produk.php">See More</a>
        </div>
    </div>
